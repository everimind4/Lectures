...
80100df4:	e8 07 36 00 00       	call   80104400 <initlock>
}
...
80100e15:	e8 66 37 00 00       	call   80104580 <acquire>
...
80100e41:	e8 fa 37 00 00       	call   80104640 <release>
      return f;
    }
  }
  release(&ftable.lock);
...
80100e5a:	e8 e1 37 00 00       	call   80104640 <release>
}
...
80100e83:	e8 f8 36 00 00       	call   80104580 <acquire>
  if(f->ref < 1)
...
80100ea0:	e8 9b 37 00 00       	call   80104640 <release>
  return f;
}
...
80100ed5:	e8 a6 36 00 00       	call   80104580 <acquire>
  if(f->ref < 1)
...
80100f0d:	89 45 e0             	mov    %eax,-0x20(%ebp)
  release(&ftable.lock);
80100f10:	e8 2b 37 00 00       	call   80104640 <release>
...
80100f3d:	5d                   	pop    %ebp
    release(&ftable.lock);
80100f3e:	e9 fd 36 00 00       	jmp    80104640 <release>
...
80101315:	e8 76 33 00 00       	call   80104690 <memset>
  log_write(bp);
...
8010135a:	e8 21 32 00 00       	call   80104580 <acquire>
  for(ip = &icache.inode[0]; ip < &icache.inode[NINODE]; ip++){
...
801013c7:	e8 74 32 00 00       	call   80104640 <release>
...
801013f2:	89 4b 08             	mov    %ecx,0x8(%ebx)
      release(&icache.lock);
801013f5:	e8 46 32 00 00       	call   80104640 <release>
      return ip;
...
80101525:	e8 06 32 00 00       	call   80104730 <memmove>
  brelse(bp);
...
8010155a:	e8 a1 2e 00 00       	call   80104400 <initlock>
  for(i = 0; i < NINODE; i++) {
...
8010165e:	e8 2d 30 00 00       	call   80104690 <memset>
      dip->type = type;
...
80101705:	e8 26 30 00 00       	call   80104730 <memmove>
  log_write(bp);
...
80101743:	e8 38 2e 00 00       	call   80104580 <acquire>
  ip->ref++;
80101748:	83 43 08 01          	addl   $0x1,0x8(%ebx)
  release(&icache.lock);
8010174c:	c7 04 24 00 0a 11 80 	movl   $0x80110a00,(%esp)
80101753:	e8 e8 2e 00 00       	call   80104640 <release>
}
...
801017f8:	e8 33 2f 00 00       	call   80104730 <memmove>
    brelse(bp);
...
801018ca:	e8 b1 2c 00 00       	call   80104580 <acquire>
  ip->ref--;
...
801018e3:	5d                   	pop    %ebp
  release(&icache.lock);
801018e4:	e9 57 2d 00 00       	jmp    80104640 <release>
801018e9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    acquire(&icache.lock);
801018f0:	83 ec 0c             	sub    $0xc,%esp
801018f3:	68 00 0a 11 80       	push   $0x80110a00
801018f8:	e8 83 2c 00 00       	call   80104580 <acquire>
    int r = ip->ref;
801018fd:	8b 73 08             	mov    0x8(%ebx),%esi
    release(&icache.lock);
80101900:	c7 04 24 00 0a 11 80 	movl   $0x80110a00,(%esp)
80101907:	e8 34 2d 00 00       	call   80104640 <release>
    if(r == 1){
...
80101b07:	e8 24 2c 00 00       	call   80104730 <memmove>
    brelse(bp);
...
80101c03:	e8 28 2b 00 00       	call   80104730 <memmove>
    log_write(bp);
...
80101ca2:	e8 f9 2a 00 00       	call   801047a0 <strncmp>
}
80101ca7:	c9                   	leave  
80101ca8:	c3                   	ret    
...
80101d05:	e8 96 2a 00 00       	call   801047a0 <strncmp>
      continue;
...
80101d9c:	e8 df 27 00 00       	call   80104580 <acquire>
  ip->ref++;
80101da1:	83 46 08 01          	addl   $0x1,0x8(%esi)
  release(&icache.lock);
80101da5:	c7 04 24 00 0a 11 80 	movl   $0x80110a00,(%esp)
80101dac:	e8 8f 28 00 00       	call   80104640 <release>
...
80101e17:	e8 14 29 00 00       	call   80104730 <memmove>
...
80101ea3:	e8 88 28 00 00       	call   80104730 <memmove>
    name[len] = 0;
...
80101fd5:	e8 16 28 00 00       	call   801047f0 <strncpy>
...
80102164:	e8 97 22 00 00       	call   80104400 <initlock>
...
801021f2:	e8 89 23 00 00       	call   80104580 <acquire>
...
8010226b:	e8 d0 23 00 00       	call   80104640 <release>
...
801022cc:	e8 af 22 00 00       	call   80104580 <acquire>
...
80102335:	c9                   	leave  
  release(&idelock);
80102336:	e9 05 23 00 00       	jmp    80104640 <release>
...
801024a6:	e8 e5 21 00 00       	call   80104690 <memset>
...
801024e0:	e8 9b 20 00 00       	call   80104580 <acquire>
...
801024fa:	c9                   	leave  
    release(&kmem.lock);
801024fb:	e9 40 21 00 00       	jmp    80104640 <release>
    panic("kfree");
...
80102579:	e8 82 1e 00 00       	call   80104400 <initlock>
  p = (char*)PGROUNDUP((uint)vstart);
...
80102663:	e8 18 1f 00 00       	call   80104580 <acquire>
  r = kmem.freelist;
...
80102691:	e8 aa 1f 00 00       	call   80104640 <release>
  return (char*)r;
...
80102abf:	e8 1c 1c 00 00       	call   801046e0 <memcmp>
...
80102bf4:	e8 37 1b 00 00       	call   80104730 <memmove>
...
80102ca8:	e8 53 17 00 00       	call   80104400 <initlock>
  readsb(dev, &sb);
80102cad:	58                   	pop    %eax
...
80102d3f:	e8 3c 18 00 00       	call   80104580 <acquire>
...
80102db2:	e8 c9 17 00 00       	call   80104580 <acquire>
  log.outstanding -= 1;
...
80102df0:	e8 4b 18 00 00       	call   80104640 <release>
}
...
80102e0a:	e8 71 17 00 00       	call   80104580 <acquire>
    wakeup(&log);
...
80102e2c:	e8 0f 18 00 00       	call   80104640 <release>
...
80102e84:	e8 a7 18 00 00       	call   80104730 <memmove>
...
80102ee4:	e8 57 17 00 00       	call   80104640 <release>
...
80102f52:	e8 29 16 00 00       	call   80104580 <acquire>
  for (i = 0; i < log.lh.n; i++) {
...
80102f94:	c9                   	leave  
  release(&log.lock);
80102f95:	e9 a6 16 00 00       	jmp    80104640 <release>
...
801030b8:	e8 73 16 00 00       	call   80104730 <memmove>
...
801031a4:	e8 37 15 00 00       	call   801046e0 <memcmp>
...
80103260:	89 45 e4             	mov    %eax,-0x1c(%ebp)
  if(memcmp(conf, "PCMP", 4) != 0)
80103263:	e8 78 14 00 00       	call   801046e0 <memcmp>
...
8010346d:	e8 8e 0f 00 00       	call   80104400 <initlock>
  (*f0)->type = FD_PIPE;
...
80103513:	e8 68 10 00 00       	call   80104580 <acquire>
  if(writable){
...
80103557:	5d                   	pop    %ebp
    release(&p->lock);
80103558:	e9 e3 10 00 00       	jmp    80104640 <release>
...
80103584:	e8 b7 10 00 00       	call   80104640 <release>
    kfree((char*)p);
...
8010363c:	e8 ff 0f 00 00       	call   80104640 <release>
        return -1;
...
80103692:	e8 a9 0f 00 00       	call   80104640 <release>
  return n;
...
801036ba:	e8 c1 0e 00 00       	call   80104580 <acquire>
...
8010375e:	e8 dd 0e 00 00       	call   80104640 <release>
  return i;
...
80103779:	e8 c2 0e 00 00       	call   80104640 <release>
      return -1;
...
801037a1:	e8 da 0d 00 00       	call   80104580 <acquire>
...
801037dc:	89 15 04 a0 10 80    	mov    %edx,0x8010a004
  release(&ptable.lock);
801037e2:	e8 59 0e 00 00       	call   80104640 <release>
...
80103804:	89 53 18             	mov    %edx,0x18(%ebx)
  *(uint*)sp = (uint)trapret;
80103807:	c7 40 14 bb 58 10 80 	movl   $0x801058bb,0x14(%eax)
  p->context = (struct context*)sp;
...
80103816:	e8 75 0e 00 00       	call   80104690 <memset>
...
8010383a:	e8 01 0e 00 00       	call   80104640 <release>
}
...
8010386f:	e8 cc 0d 00 00       	call   80104640 <release>
...
801038c4:	e8 37 0b 00 00       	call   80104400 <initlock>
}
...
8010392d:	68 60 77 10 80       	push   $0x80107760
...
80103968:	83 ec 04             	sub    $0x4,%esp
  pushcli();
8010396b:	e8 10 0b 00 00       	call   80104480 <pushcli>
  c = mycpu();
80103970:	e8 5b ff ff ff       	call   801038d0 <mycpu>
  p = c->proc;
80103975:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
8010397b:	e8 50 0b 00 00       	call   801044d0 <popcli>
}
...
801039da:	e8 b1 0c 00 00       	call   80104690 <memset>
...
80103a39:	e8 12 0e 00 00       	call   80104850 <safestrcpy>
  p->cwd = namei("/");
...
80103a99:	8b 75 08             	mov    0x8(%ebp),%esi
  pushcli();
80103a9c:	e8 df 09 00 00       	call   80104480 <pushcli>
  c = mycpu();
80103aa1:	e8 2a fe ff ff       	call   801038d0 <mycpu>
  p = c->proc;
80103aa6:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103aac:	e8 1f 0a 00 00       	call   801044d0 <popcli>
  sz = curproc->sz;
...
80103b1a:	83 ec 1c             	sub    $0x1c,%esp
  pushcli();
80103b1d:	e8 5e 09 00 00       	call   80104480 <pushcli>
  c = mycpu();
80103b22:	e8 a9 fd ff ff       	call   801038d0 <mycpu>
  p = c->proc;
80103b27:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103b2d:	e8 9e 09 00 00       	call   801044d0 <popcli>
  if((np = allocproc()) == 0){
...
80103c66:	e8 15 09 00 00       	call   80104580 <acquire>
...
80103c8b:	c7 43 0c 04 00 00 00 	movl   $0x4,0xc(%ebx)
      swtch(&(c->scheduler), p->context);
80103c92:	e8 1c 0c 00 00       	call   801048b3 <swtch>
      switchkvm();
...
80103d37:	e8 77 0b 00 00       	call   801048b3 <swtch>
  mycpu()->intena = intena;
...
80103d9a:	83 ec 0c             	sub    $0xc,%esp
  pushcli();
80103d9d:	e8 de 06 00 00       	call   80104480 <pushcli>
  c = mycpu();
80103da2:	e8 29 fb ff ff       	call   801038d0 <mycpu>
  p = c->proc;
80103da7:	8b b0 ac 00 00 00    	mov    0xac(%eax),%esi
  popcli();
80103dad:	e8 1e 07 00 00       	call   801044d0 <popcli>
  if(curproc == initproc)
...
80103e0a:	e8 71 07 00 00       	call   80104580 <acquire>
...
80103ee0:	e8 9b 06 00 00       	call   80104580 <acquire>
  pushcli();
80103ee5:	e8 96 05 00 00       	call   80104480 <pushcli>
  c = mycpu();
80103eea:	e8 e1 f9 ff ff       	call   801038d0 <mycpu>
  p = c->proc;
80103eef:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103ef5:	e8 d6 05 00 00       	call   801044d0 <popcli>
...
80103f0d:	e8 2e 07 00 00       	call   80104640 <release>
}
...
80103f30:	8b 75 0c             	mov    0xc(%ebp),%esi
  pushcli();
80103f33:	e8 48 05 00 00       	call   80104480 <pushcli>
  c = mycpu();
80103f38:	e8 93 f9 ff ff       	call   801038d0 <mycpu>
  p = c->proc;
80103f3d:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103f43:	e8 88 05 00 00       	call   801044d0 <popcli>
  if(p == 0)
...
80103f64:	e8 17 06 00 00       	call   80104580 <acquire>
    release(lk);
80103f69:	89 34 24             	mov    %esi,(%esp)
80103f6c:	e8 cf 06 00 00       	call   80104640 <release>
  p->chan = chan;
...
80103f8e:	e8 ad 06 00 00       	call   80104640 <release>
    acquire(lk);
...
80103f9f:	5d                   	pop    %ebp
    acquire(lk);
80103fa0:	e9 db 05 00 00       	jmp    80104580 <acquire>
...
801040a6:	c7 43 0c 00 00 00 00 	movl   $0x0,0xc(%ebx)
        release(&ptable.lock);
801040ad:	e8 8e 05 00 00       	call   80104640 <release>
        return pid;
...
801040cb:	e8 70 05 00 00       	call   80104640 <release>
      return -1;
...
801040f3:	e8 88 04 00 00       	call   80104580 <acquire>
...
80104138:	c9                   	leave  
  release(&ptable.lock);
80104139:	e9 02 05 00 00       	jmp    80104640 <release>
...
80104153:	e8 28 04 00 00       	call   80104580 <acquire>
...
80104193:	e8 a8 04 00 00       	call   80104640 <release>
      return 0;
    }
  }
  release(&ptable.lock);
...
801041b0:	e8 8b 04 00 00       	call   80104640 <release>
}
...
80104220:	8b 14 85 88 77 10 80 	mov    -0x7fef8878(,%eax,4),%edx
      state = "???";
...
8010425d:	e8 be 01 00 00       	call   80104420 <getcallerpcs>
      for(i=0; i<10 && pc[i] != 0; i++)
...
801042aa:	ff 35 b8 a5 10 80    	pushl  0x8010a5b8
801042b0:	68 18 77 10 80       	push   $0x80107718
801042b5:	e8 f6 c3 ff ff       	call   801006b0 <cprintf>
}
...
801042ce:	68 a0 77 10 80       	push   $0x801077a0
...
8010432d:	e8 ee fb ff ff       	call   80103f20 <sleep>
  while (lk->locked) {
...
8010433b:	c7 03 01 00 00 00    	movl   $0x1,(%ebx)
  lk->pid = myproc()->pid;
80104341:	e8 1a f6 ff ff       	call   80103960 <myproc>
...
801043e3:	e8 78 f5 ff ff       	call   80103960 <myproc>
...
801044af:	90                   	nop
    mycpu()->intena = eflags & FL_IF;
801044b0:	e8 1b f4 ff ff       	call   801038d0 <mycpu>
...
801044ff:	c3                   	ret    
  if(mycpu()->ncli == 0 && mycpu()->intena)
80104500:	e8 cb f3 ff ff       	call   801038d0 <mycpu>
...
80104515:	68 ab 77 10 80       	push   $0x801077ab
8010451a:	e8 71 be ff ff       	call   80100390 <panic>
    panic("popcli");
8010451f:	83 ec 0c             	sub    $0xc,%esp
80104522:	68 c2 77 10 80       	push   $0x801077c2
...
8010455b:	e8 70 f3 ff ff       	call   801038d0 <mycpu>
...
801045c4:	e8 07 f3 ff ff       	call   801038d0 <mycpu>
...
80104627:	68 c9 77 10 80       	push   $0x801077c9
...
80104680:	68 d1 77 10 80       	push   $0x801077d1
...
801048db:	8b 5d 08             	mov    0x8(%ebp),%ebx
  struct proc *curproc = myproc();
801048de:	e8 7d f0 ff ff       	call   80103960 <myproc>
...
80104979:	e8 e2 ef ff ff       	call   80103960 <myproc>
...
80104987:	8d 1c 90             	lea    (%eax,%edx,4),%ebx
  struct proc *curproc = myproc();
8010498a:	e8 d1 ef ff ff       	call   80103960 <myproc>
  return fetchint((myproc()->tf->esp) + 4 + 4*n, ip);
...
801049cc:	8b 5d 10             	mov    0x10(%ebp),%ebx
  int i;
  struct proc *curproc = myproc();
801049cf:	e8 8c ef ff ff       	call   80103960 <myproc>
...
80104a68:	83 ec 04             	sub    $0x4,%esp
  int num;
  struct proc *curproc = myproc();
80104a6b:	e8 f0 ee ff ff       	call   80103960 <myproc>
...
80104aa8:	68 d9 77 10 80       	push   $0x801077d9
...
80104ae7:	89 4d cc             	mov    %ecx,-0x34(%ebp)
  if((dp = nameiparent(path, name)) == 0)
80104aea:	e8 61 d5 ff ff       	call   80102050 <nameiparent>
...
80104b00:	e8 5b cc ff ff       	call   80101760 <ilock>
...
80104b0c:	e8 9f d1 ff ff       	call   80101cb0 <dirlookup>
...
80104b1e:	e8 dd ce ff ff       	call   80101a00 <iunlockput>
    ilock(ip);
80104b23:	89 34 24             	mov    %esi,(%esp)
80104b26:	e8 35 cc ff ff       	call   80101760 <ilock>
...
80104b54:	31 f6                	xor    %esi,%esi
    iunlockput(ip);
80104b56:	e8 a5 ce ff ff       	call   80101a00 <iunlockput>
    return 0;
...
80104b7a:	e8 61 ca ff ff       	call   801015e0 <ialloc>
...
80104bb1:	e8 ea ca ff ff       	call   801016a0 <iupdate>
...
80104bc8:	e8 a3 d3 ff ff       	call   80101f70 <dirlink>
...
80104bd8:	e8 23 ce ff ff       	call   80101a00 <iunlockput>
  return ip;
...
80104bf9:	e8 a2 ca ff ff       	call   801016a0 <iupdate>
    if(dirlink(ip, ".", ip->inum) < 0 || dirlink(ip, "..", dp->inum) < 0)
80104bfe:	83 c4 0c             	add    $0xc,%esp
80104c01:	ff 76 04             	pushl  0x4(%esi)
80104c04:	68 78 78 10 80       	push   $0x80107878
80104c09:	56                   	push   %esi
80104c0a:	e8 61 d3 ff ff       	call   80101f70 <dirlink>
...
80104c1c:	68 77 78 10 80       	push   $0x80107877
80104c21:	56                   	push   %esi
80104c22:	e8 49 d3 ff ff       	call   80101f70 <dirlink>
...
80104c31:	68 6b 78 10 80       	push   $0x8010786b
...
80104c4f:	68 7a 78 10 80       	push   $0x8010787a
80104c54:	e8 37 b7 ff ff       	call   80100390 <panic>
    panic("create: ialloc");
80104c59:	83 ec 0c             	sub    $0xc,%esp
80104c5c:	68 5c 78 10 80       	push   $0x8010785c
...
80104c94:	e8 c7 ec ff ff       	call   80103960 <myproc>
...
80104cdd:	31 db                	xor    %ebx,%ebx
  struct proc *curproc = myproc();
80104cdf:	e8 7c ec ff ff       	call   80103960 <myproc>
  for(fd = 0; fd < NOFILE; fd++){
...
80104d1a:	e8 51 c1 ff ff       	call   80100e70 <filedup>
  return fd;
...
80104d39:	83 ec 18             	sub    $0x18,%esp
  readcount++;
80104d3c:	83 05 b8 a5 10 80 01 	addl   $0x1,0x8010a5b8
  if(argfd(0, 0, &f) < 0 || argint(2, &n) < 0 || argptr(1, &p, n) < 0)
80104d43:	8d 55 ec             	lea    -0x14(%ebp),%edx
80104d46:	e8 25 ff ff ff       	call   80104c70 <argfd.constprop.0>
80104d4b:	85 c0                	test   %eax,%eax
80104d4d:	78 49                	js     80104d98 <sys_read+0x68>
80104d4f:	83 ec 08             	sub    $0x8,%esp
80104d52:	8d 45 f0             	lea    -0x10(%ebp),%eax
80104d55:	50                   	push   %eax
80104d56:	6a 02                	push   $0x2
80104d58:	e8 13 fc ff ff       	call   80104970 <argint>
80104d5d:	83 c4 10             	add    $0x10,%esp
80104d60:	85 c0                	test   %eax,%eax
80104d62:	78 34                	js     80104d98 <sys_read+0x68>
80104d64:	83 ec 04             	sub    $0x4,%esp
80104d67:	8d 45 f4             	lea    -0xc(%ebp),%eax
80104d6a:	ff 75 f0             	pushl  -0x10(%ebp)
80104d6d:	50                   	push   %eax
80104d6e:	6a 01                	push   $0x1
80104d70:	e8 4b fc ff ff       	call   801049c0 <argptr>
80104d75:	83 c4 10             	add    $0x10,%esp
80104d78:	85 c0                	test   %eax,%eax
80104d7a:	78 1c                	js     80104d98 <sys_read+0x68>
  return fileread(f, p, n);
80104d7c:	83 ec 04             	sub    $0x4,%esp
80104d7f:	ff 75 f0             	pushl  -0x10(%ebp)
80104d82:	ff 75 f4             	pushl  -0xc(%ebp)
80104d85:	ff 75 ec             	pushl  -0x14(%ebp)
80104d88:	e8 63 c2 ff ff       	call   80100ff0 <fileread>
...
80104df1:	e8 9a c2 ff ff       	call   80101090 <filewrite>
...
80104e27:	78 27                	js     80104e50 <sys_close+0x40>
  myproc()->ofile[fd] = 0;
80104e29:	e8 32 eb ff ff       	call   80103960 <myproc>
...
80104e3f:	e8 7c c0 ff ff       	call   80100ec0 <fileclose>
  return 0;
...
80104e98:	e8 03 c1 ff ff       	call   80100fa0 <filestat>
...
80104ee6:	0f 88 e6 00 00 00    	js     80104fd2 <sys_link+0x122>
  begin_op();
80104eec:	e8 3f de ff ff       	call   80102d30 <begin_op>
  if((ip = namei(old)) == 0){
80104ef1:	83 ec 0c             	sub    $0xc,%esp
80104ef4:	ff 75 d4             	pushl  -0x2c(%ebp)
80104ef7:	e8 34 d1 ff ff       	call   80102030 <namei>
...
80104f0d:	e8 4e c8 ff ff       	call   80101760 <ilock>
  if(ip->type == T_DIR){
...
80104f2c:	e8 6f c7 ff ff       	call   801016a0 <iupdate>
  iunlock(ip);
80104f31:	89 1c 24             	mov    %ebx,(%esp)
80104f34:	e8 07 c9 ff ff       	call   80101840 <iunlock>
  if((dp = nameiparent(new, name)) == 0)
80104f39:	58                   	pop    %eax
80104f3a:	5a                   	pop    %edx
80104f3b:	57                   	push   %edi
80104f3c:	ff 75 d0             	pushl  -0x30(%ebp)
80104f3f:	e8 0c d1 ff ff       	call   80102050 <nameiparent>
...
80104f51:	e8 0a c8 ff ff       	call   80101760 <ilock>
...
80104f67:	e8 04 d0 ff ff       	call   80101f70 <dirlink>
...
80104f77:	e8 84 ca ff ff       	call   80101a00 <iunlockput>
  iput(ip);
80104f7c:	89 1c 24             	mov    %ebx,(%esp)
80104f7f:	e8 0c c9 ff ff       	call   80101890 <iput>
  end_op();
80104f84:	e8 17 de ff ff       	call   80102da0 <end_op>
  return 0;
...
80104fa4:	e8 57 ca ff ff       	call   80101a00 <iunlockput>
    goto bad;
80104fa9:	83 c4 10             	add    $0x10,%esp
  ilock(ip);
80104fac:	83 ec 0c             	sub    $0xc,%esp
80104faf:	53                   	push   %ebx
80104fb0:	e8 ab c7 ff ff       	call   80101760 <ilock>
  ip->nlink--;
80104fb5:	66 83 6b 56 01       	subw   $0x1,0x56(%ebx)
  iupdate(ip);
80104fba:	89 1c 24             	mov    %ebx,(%esp)
80104fbd:	e8 de c6 ff ff       	call   801016a0 <iupdate>
  iunlockput(ip);
80104fc2:	89 1c 24             	mov    %ebx,(%esp)
80104fc5:	e8 36 ca ff ff       	call   80101a00 <iunlockput>
  end_op();
80104fca:	e8 d1 dd ff ff       	call   80102da0 <end_op>
  return -1;
...
80104fdd:	e8 1e ca ff ff       	call   80101a00 <iunlockput>
    end_op();
80104fe2:	e8 b9 dd ff ff       	call   80102da0 <end_op>
    return -1;
80104fe7:	83 c4 10             	add    $0x10,%esp
80104fea:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80104fef:	eb 9d                	jmp    80104f8e <sys_link+0xde>
    end_op();
80104ff1:	e8 aa dd ff ff       	call   80102da0 <end_op>
    return -1;
...
80105048:	e8 13 c7 ff ff       	call   80101760 <ilock>
  if(namecmp(name, ".") == 0 || namecmp(name, "..") == 0)
8010504d:	58                   	pop    %eax
8010504e:	5a                   	pop    %edx
8010504f:	68 78 78 10 80       	push   $0x80107878
80105054:	53                   	push   %ebx
80105055:	e8 36 cc ff ff       	call   80101c90 <namecmp>
...
80105068:	68 77 78 10 80       	push   $0x80107877
8010506d:	53                   	push   %ebx
8010506e:	e8 1d cc ff ff       	call   80101c90 <namecmp>
...
80105087:	e8 24 cc ff ff       	call   80101cb0 <dirlookup>
...
8010509d:	e8 be c6 ff ff       	call   80101760 <ilock>
  if(ip->nlink < 1)
...
801050ce:	e8 8d ca ff ff       	call   80101b60 <writei>
...
801050fb:	e8 a0 c5 ff ff       	call   801016a0 <iupdate>
  iunlockput(ip);
80105100:	89 1c 24             	mov    %ebx,(%esp)
80105103:	e8 f8 c8 ff ff       	call   80101a00 <iunlockput>
  end_op();
80105108:	e8 93 dc ff ff       	call   80102da0 <end_op>
  return 0;
...
80105140:	e8 1b c9 ff ff       	call   80101a60 <readi>
...
8010515b:	e8 a0 c8 ff ff       	call   80101a00 <iunlockput>
    goto bad;
...
8010516c:	e8 8f c8 ff ff       	call   80101a00 <iunlockput>
  end_op();
...
80105189:	e8 12 c5 ff ff       	call   801016a0 <iupdate>
...
80105216:	78 75                	js     8010528d <sys_open+0xad>
  ...
  begin_op();
80105218:	e8 13 db ff ff       	call   80102d30 <begin_op>
...
80105229:	e8 02 ce ff ff       	call   80102030 <namei>
...
8010523b:	e8 20 c5 ff ff       	call   80101760 <ilock>
...
80105280:	e8 7b c7 ff ff       	call   80101a00 <iunlockput>
    end_op();
80105285:	e8 16 db ff ff       	call   80102da0 <end_op>
    return -1;
...
801052d0:	e8 6b c5 ff ff       	call   80101840 <iunlock>
  end_op();
...
80105327:	83 ec 18             	sub    $0x18,%esp
  ...
  begin_op();
8010532a:	e8 01 da ff ff       	call   80102d30 <begin_op>
...
80105402:	e8 f9 c5 ff ff       	call   80101a00 <iunlockput>
  end_op();
80105407:	e8 94 d9 ff ff       	call   80102da0 <end_op>
  return 0;
...
80105439:	83 ec 10             	sub    $0x10,%esp
  ...
  struct inode *ip;
  struct proc *curproc = myproc();
8010543c:	e8 1f e5 ff ff       	call   80103960 <myproc>
80105441:	89 c6                	mov    %eax,%esi
  
  begin_op();
80105443:	e8 e8 d8 ff ff       	call   80102d30 <begin_op>
...
80105463:	e8 c8 cb ff ff       	call   80102030 <namei>
...
80105475:	e8 e6 c2 ff ff       	call   80101760 <ilock>
  if(ip->type != T_DIR){
...
80105488:	e8 b3 c3 ff ff       	call   80101840 <iunlock>
  iput(curproc->cwd);
8010548d:	58                   	pop    %eax
8010548e:	ff 76 68             	pushl  0x68(%esi)
80105491:	e8 fa c3 ff ff       	call   80101890 <iput>
  end_op();
80105496:	e8 05 d9 ff ff       	call   80102da0 <end_op>
  curproc->cwd = ip;
...
801054b4:	e8 47 c5 ff ff       	call   80101a00 <iunlockput>
    end_op();
801054b9:	e8 e2 d8 ff ff       	call   80102da0 <end_op>
    return -1;
...
801054cf:	90                   	nop
    end_op();
801054d0:	e8 cb d8 ff ff       	call   80102da0 <end_op>
    return -1;
...
8010560c:	e8 df dd ff ff       	call   801033f0 <pipealloc>
...
8010561b:	31 db                	xor    %ebx,%ebx
  struct proc *curproc = myproc();
8010561d:	e8 3e e3 ff ff       	call   80103960 <myproc>
  for(fd = 0; fd < NOFILE; fd++){
...
8010563e:	e8 7d b8 ff ff       	call   80100ec0 <fileclose>
    fileclose(wf);
80105643:	58                   	pop    %eax
80105644:	ff 75 e4             	pushl  -0x1c(%ebp)
80105647:	e8 74 b8 ff ff       	call   80100ec0 <fileclose>
    return -1;
...
80105667:	8b 7d e4             	mov    -0x1c(%ebp),%edi
  struct proc *curproc = myproc();
8010566a:	e8 f1 e2 ff ff       	call   80103960 <myproc>
  for(fd = 0; fd < NOFILE; fd++){
...
80105686:	75 f0                	jne    80105678 <sys_pipe+0x98>
      myproc()->ofile[fd0] = 0;
80105688:	e8 d3 e2 ff ff       	call   80103960 <myproc>
...
801056c0:	f3 0f 1e fb          	endbr32 
  return fork();
801056c4:	e9 47 e4 ff ff       	jmp    80103b10 <fork>
...
801056d7:	83 ec 08             	sub    $0x8,%esp
  exit();
801056da:	e8 b1 e6 ff ff       	call   80103d90 <exit>
...
801056f0:	f3 0f 1e fb          	endbr32 
  return wait();
801056f4:	e9 e7 e8 ff ff       	jmp    80103fe0 <wait>
...
80105722:	e8 19 ea ff ff       	call   80104140 <kill>
...
80105747:	83 ec 08             	sub    $0x8,%esp
  return myproc()->pid;
8010574a:	e8 11 e2 ff ff       	call   80103960 <myproc>
...
80105782:	83 ec 0c             	sub    $0xc,%esp
  addr = myproc()->sz;
80105785:	8b 18                	mov    (%eax),%ebx
  if(growproc(n) < 0)
80105787:	ff 75 f4             	pushl  -0xc(%ebp)
8010578a:	e8 01 e3 ff ff       	call   80103a90 <growproc>
8010578f:	83 c4 10             	add    $0x10,%esp
80105792:	85 c0                	test   %eax,%eax
80105794:	78 0a                	js     801057a0 <sys_sbrk+0x40>
    return -1;
  return addr;
}
80105796:	89 d8                	mov    %ebx,%eax
...
801057a5:	eb ef                	jmp    80105796 <sys_sbrk+0x36>
...
801057d4:	68 80 4c 11 80       	push   $0x80114c80
801057d9:	e8 a2 ed ff ff       	call   80104580 <acquire>
  ticks0 = ticks;
  while(ticks - ticks0 < n){
801057de:	8b 55 f4             	mov    -0xc(%ebp),%edx
  ticks0 = ticks;
801057e1:	8b 1d c0 54 11 80    	mov    0x801154c0,%ebx
  while(ticks - ticks0 < n){
...
801057fd:	e8 1e e7 ff ff       	call   80103f20 <sleep>
  while(ticks - ticks0 < n){
...
8010580f:	73 2f                	jae    80105840 <sys_sleep+0x90>
    if(myproc()->killed){
80105811:	e8 4a e1 ff ff       	call   80103960 <myproc>
...
80105868:	83 ec 10             	sub    $0x10,%esp
  ...
  acquire(&tickslock);
8010586b:	68 80 4c 11 80       	push   $0x80114c80
80105870:	e8 0b ed ff ff       	call   80104580 <acquire>
  xticks = ticks;
80105875:	8b 1d c0 54 11 80    	mov    0x801154c0,%ebx
  release(&tickslock);
8010587b:	c7 04 24 80 4c 11 80 	movl   $0x80114c80,(%esp)
...
80105897:	83 ec 08             	sub    $0x8,%esp
  getreadcount();
8010589a:	e8 01 ea ff ff       	call   801042a0 <getreadcount>
  return 0;
}
...
801058a4:	06                   	push   %es
  pushl %fs
801058a5:	0f a0                	push   %fs
  pushl %gs
801058a7:	0f a8                	push   %gs
  pushal
801058a9:	60                   	pusha  
  
  # Set up data segments.
  movw $(SEG_KDATA<<3), %ax
801058aa:	66 b8 10 00          	mov    $0x10,%ax
  movw %ax, %ds
801058ae:	8e d8                	mov    %eax,%ds
  movw %ax, %es
801058b0:	8e c0                	mov    %eax,%es

  # Call trap(tf), where tf=%esp
  pushl %esp
801058b2:	54                   	push   %esp
  call trap
801058b3:	e8 c8 00 00 00       	call   80105980 <trap>
  addl $4, %esp
801058b8:	83 c4 04             	add    $0x4,%esp
...
801058bb:	61                   	popa   
  popl %gs
801058bc:	0f a9                	pop    %gs
  popl %fs
801058be:	0f a1                	pop    %fs
  popl %es
801058c0:	07                   	pop    %es
  popl %ds
801058c1:	1f                   	pop    %ds
  addl $0x8, %esp  # trapno and errcode
801058c2:	83 c4 08             	add    $0x8,%esp
  iret
801058c5:	cf                   	iret   
...
8010591e:	00 00 ef 
  initlock(&tickslock, "time");
80105921:	68 bd 78 10 80       	push   $0x801078bd
...
80105934:	66 a3 c6 4e 11 80    	mov    %ax,0x80114ec6
  initlock(&tickslock, "time");
8010593a:	e8 c1 ea ff ff       	call   80104400 <initlock>
}
...
8010595f:	66 89 45 fa          	mov    %ax,-0x6(%ebp)
  pd[1] = (uint)p;
80105963:	b8 c0 4c 11 80       	mov    $0x80114cc0,%eax
...
801059a4:	3e ff 24 85 64 79 10 	notrack jmp *-0x7fef869c(,%eax,4)
801059ab:	80 
    lapiceoi();
    break;
...
80105a01:	68 20 79 10 80       	push   $0x80107920
...
80105aa7:	68 80 4c 11 80       	push   $0x80114c80
80105aac:	e8 cf ea ff ff       	call   80104580 <acquire>
      wakeup(&ticks);
80105ab1:	c7 04 24 c0 54 11 80 	movl   $0x801154c0,(%esp)
      ticks++;
80105ab8:	83 05 c0 54 11 80 01 	addl   $0x1,0x801154c0
      wakeup(&ticks);
80105abf:	e8 1c e6 ff ff       	call   801040e0 <wakeup>
      release(&tickslock);
80105ac4:	c7 04 24 80 4c 11 80 	movl   $0x80114c80,(%esp)
80105acb:	e8 70 eb ff ff       	call   80104640 <release>
...
80105b1c:	68 c8 78 10 80       	push   $0x801078c8
...
80105b69:	89 58 18             	mov    %ebx,0x18(%eax)
    syscall();
80105b6c:	e8 ef ee ff ff       	call   80104a60 <syscall>
    if(myproc()->killed)
...
80105bb8:	68 ec 78 10 80       	push   $0x801078ec
80105bbd:	e8 ee aa ff ff       	call   801006b0 <cprintf>
      panic("trap");
80105bc2:	83 c4 14             	add    $0x14,%esp
80105bc5:	68 c2 78 10 80       	push   $0x801078c2
...
80105bd0:	f3 0f 1e fb          	endbr32 
  if(!uart)
80105bd4:	a1 c0 a5 10 80       	mov    0x8010a5c0,%eax
...
80105cab:	74 52                	je     80105cff <uartinit+0xaf>
  uart = 1;
80105cad:	c7 05 c0 a5 10 80 01 	movl   $0x1,0x8010a5c0
80105cb4:	00 00 00 
...
80105cc3:	be 76 00 00 00       	mov    $0x76,%esi
  for(p="xv6...\n"; *p; p++)
80105cc8:	bb e4 79 10 80       	mov    $0x801079e4,%ebx
  ioapicenable(IRQ_COM1, 0);
...
80105ce0:	0f b6 73 01          	movzbl 0x1(%ebx),%esi
  if(!uart)
80105ce4:	8b 15 c0 a5 10 80    	mov    0x8010a5c0,%edx
...
80105d14:	55                   	push   %ebp
  if(!uart)
80105d15:	8b 15 c0 a5 10 80    	mov    0x8010a5c0,%edx
{
...
80105d5b:	6a 00                	push   $0x0
  jmp alltraps
80105d5d:	e9 41 fb ff ff       	jmp    801058a3 <alltraps>
...
80105d64:	6a 01                	push   $0x1
  jmp alltraps
80105d66:	e9 38 fb ff ff       	jmp    801058a3 <alltraps>
...
80105d6d:	6a 02                	push   $0x2
  jmp alltraps
80105d6f:	e9 2f fb ff ff       	jmp    801058a3 <alltraps>
...
80105d76:	6a 03                	push   $0x3
  jmp alltraps
80105d78:	e9 26 fb ff ff       	jmp    801058a3 <alltraps>
...
80105d7f:	6a 04                	push   $0x4
  jmp alltraps
80105d81:	e9 1d fb ff ff       	jmp    801058a3 <alltraps>
...
80105d88:	6a 05                	push   $0x5
  jmp alltraps
80105d8a:	e9 14 fb ff ff       	jmp    801058a3 <alltraps>
...
80105d91:	6a 06                	push   $0x6
  jmp alltraps
80105d93:	e9 0b fb ff ff       	jmp    801058a3 <alltraps>
...
80105d9a:	6a 07                	push   $0x7
  jmp alltraps
80105d9c:	e9 02 fb ff ff       	jmp    801058a3 <alltraps>
...
80105da1:	6a 08                	push   $0x8
  jmp alltraps
80105da3:	e9 fb fa ff ff       	jmp    801058a3 <alltraps>
...
80105daa:	6a 09                	push   $0x9
  jmp alltraps
80105dac:	e9 f2 fa ff ff       	jmp    801058a3 <alltraps>
...
80105db1:	6a 0a                	push   $0xa
  jmp alltraps
80105db3:	e9 eb fa ff ff       	jmp    801058a3 <alltraps>
...
80105db8:	6a 0b                	push   $0xb
  jmp alltraps
80105dba:	e9 e4 fa ff ff       	jmp    801058a3 <alltraps>
...
80105dbf:	6a 0c                	push   $0xc
  jmp alltraps
80105dc1:	e9 dd fa ff ff       	jmp    801058a3 <alltraps>
...
80105dc6:	6a 0d                	push   $0xd
  jmp alltraps
80105dc8:	e9 d6 fa ff ff       	jmp    801058a3 <alltraps>
...
80105dcd:	6a 0e                	push   $0xe
  jmp alltraps
80105dcf:	e9 cf fa ff ff       	jmp    801058a3 <alltraps>
...
80105dd6:	6a 0f                	push   $0xf
  jmp alltraps
80105dd8:	e9 c6 fa ff ff       	jmp    801058a3 <alltraps>
...
80105ddf:	6a 10                	push   $0x10
  jmp alltraps
80105de1:	e9 bd fa ff ff       	jmp    801058a3 <alltraps>
...
80105de6:	6a 11                	push   $0x11
  jmp alltraps
80105de8:	e9 b6 fa ff ff       	jmp    801058a3 <alltraps>
...
80105def:	6a 12                	push   $0x12
  jmp alltraps
80105df1:	e9 ad fa ff ff       	jmp    801058a3 <alltraps>
...
80105df8:	6a 13                	push   $0x13
  jmp alltraps
80105dfa:	e9 a4 fa ff ff       	jmp    801058a3 <alltraps>
...
80105e01:	6a 14                	push   $0x14
  jmp alltraps
80105e03:	e9 9b fa ff ff       	jmp    801058a3 <alltraps>
...
80105e0a:	6a 15                	push   $0x15
  jmp alltraps
80105e0c:	e9 92 fa ff ff       	jmp    801058a3 <alltraps>
...
80105e13:	6a 16                	push   $0x16
  jmp alltraps
80105e15:	e9 89 fa ff ff       	jmp    801058a3 <alltraps>
...
80105e1c:	6a 17                	push   $0x17
  jmp alltraps
80105e1e:	e9 80 fa ff ff       	jmp    801058a3 <alltraps>
...
80105e25:	6a 18                	push   $0x18
  jmp alltraps
80105e27:	e9 77 fa ff ff       	jmp    801058a3 <alltraps>
...
80105e2e:	6a 19                	push   $0x19
  jmp alltraps
80105e30:	e9 6e fa ff ff       	jmp    801058a3 <alltraps>
...
80105e37:	6a 1a                	push   $0x1a
  jmp alltraps
80105e39:	e9 65 fa ff ff       	jmp    801058a3 <alltraps>
...
80105e40:	6a 1b                	push   $0x1b
  jmp alltraps
80105e42:	e9 5c fa ff ff       	jmp    801058a3 <alltraps>
...
80105e49:	6a 1c                	push   $0x1c
  jmp alltraps
80105e4b:	e9 53 fa ff ff       	jmp    801058a3 <alltraps>
...
80105e52:	6a 1d                	push   $0x1d
  jmp alltraps
80105e54:	e9 4a fa ff ff       	jmp    801058a3 <alltraps>
...
80105e5b:	6a 1e                	push   $0x1e
  jmp alltraps
80105e5d:	e9 41 fa ff ff       	jmp    801058a3 <alltraps>
...
80105e64:	6a 1f                	push   $0x1f
  jmp alltraps
80105e66:	e9 38 fa ff ff       	jmp    801058a3 <alltraps>
...
80105e6d:	6a 20                	push   $0x20
  jmp alltraps
80105e6f:	e9 2f fa ff ff       	jmp    801058a3 <alltraps>
...
80105e76:	6a 21                	push   $0x21
  jmp alltraps
80105e78:	e9 26 fa ff ff       	jmp    801058a3 <alltraps>
...
80105e7f:	6a 22                	push   $0x22
  jmp alltraps
80105e81:	e9 1d fa ff ff       	jmp    801058a3 <alltraps>
...
80105e88:	6a 23                	push   $0x23
  jmp alltraps
80105e8a:	e9 14 fa ff ff       	jmp    801058a3 <alltraps>
...
80105e91:	6a 24                	push   $0x24
  jmp alltraps
80105e93:	e9 0b fa ff ff       	jmp    801058a3 <alltraps>
...
80105e9a:	6a 25                	push   $0x25
  jmp alltraps
80105e9c:	e9 02 fa ff ff       	jmp    801058a3 <alltraps>
...
80105ea3:	6a 26                	push   $0x26
  jmp alltraps
80105ea5:	e9 f9 f9 ff ff       	jmp    801058a3 <alltraps>
...
80105eac:	6a 27                	push   $0x27
  jmp alltraps
80105eae:	e9 f0 f9 ff ff       	jmp    801058a3 <alltraps>
...
80105eb5:	6a 28                	push   $0x28
  jmp alltraps
80105eb7:	e9 e7 f9 ff ff       	jmp    801058a3 <alltraps>
...
80105ebe:	6a 29                	push   $0x29
  jmp alltraps
80105ec0:	e9 de f9 ff ff       	jmp    801058a3 <alltraps>
...
80105ec7:	6a 2a                	push   $0x2a
  jmp alltraps
80105ec9:	e9 d5 f9 ff ff       	jmp    801058a3 <alltraps>
...
80105ed0:	6a 2b                	push   $0x2b
  jmp alltraps
80105ed2:	e9 cc f9 ff ff       	jmp    801058a3 <alltraps>
...
80105ed9:	6a 2c                	push   $0x2c
  jmp alltraps
80105edb:	e9 c3 f9 ff ff       	jmp    801058a3 <alltraps>
...
80105ee2:	6a 2d                	push   $0x2d
  jmp alltraps
80105ee4:	e9 ba f9 ff ff       	jmp    801058a3 <alltraps>
...
80105eeb:	6a 2e                	push   $0x2e
  jmp alltraps
80105eed:	e9 b1 f9 ff ff       	jmp    801058a3 <alltraps>
...
80105ef4:	6a 2f                	push   $0x2f
  jmp alltraps
80105ef6:	e9 a8 f9 ff ff       	jmp    801058a3 <alltraps>
...
80105efd:	6a 30                	push   $0x30
  jmp alltraps
80105eff:	e9 9f f9 ff ff       	jmp    801058a3 <alltraps>
...
80105f06:	6a 31                	push   $0x31
  jmp alltraps
80105f08:	e9 96 f9 ff ff       	jmp    801058a3 <alltraps>
...
80105f0f:	6a 32                	push   $0x32
  jmp alltraps
80105f11:	e9 8d f9 ff ff       	jmp    801058a3 <alltraps>
...
80105f18:	6a 33                	push   $0x33
  jmp alltraps
80105f1a:	e9 84 f9 ff ff       	jmp    801058a3 <alltraps>
...
80105f21:	6a 34                	push   $0x34
  jmp alltraps
80105f23:	e9 7b f9 ff ff       	jmp    801058a3 <alltraps>
...
80105f2a:	6a 35                	push   $0x35
  jmp alltraps
80105f2c:	e9 72 f9 ff ff       	jmp    801058a3 <alltraps>
...
80105f33:	6a 36                	push   $0x36
  jmp alltraps
80105f35:	e9 69 f9 ff ff       	jmp    801058a3 <alltraps>
...
80105f3c:	6a 37                	push   $0x37
  jmp alltraps
80105f3e:	e9 60 f9 ff ff       	jmp    801058a3 <alltraps>
...
80105f45:	6a 38                	push   $0x38
  jmp alltraps
80105f47:	e9 57 f9 ff ff       	jmp    801058a3 <alltraps>
...
80105f4e:	6a 39                	push   $0x39
  jmp alltraps
80105f50:	e9 4e f9 ff ff       	jmp    801058a3 <alltraps>
...
80105f57:	6a 3a                	push   $0x3a
  jmp alltraps
80105f59:	e9 45 f9 ff ff       	jmp    801058a3 <alltraps>
...
80105f60:	6a 3b                	push   $0x3b
  jmp alltraps
80105f62:	e9 3c f9 ff ff       	jmp    801058a3 <alltraps>
...
80105f69:	6a 3c                	push   $0x3c
  jmp alltraps
80105f6b:	e9 33 f9 ff ff       	jmp    801058a3 <alltraps>
...
80105f72:	6a 3d                	push   $0x3d
  jmp alltraps
80105f74:	e9 2a f9 ff ff       	jmp    801058a3 <alltraps>
...
80105f7b:	6a 3e                	push   $0x3e
  jmp alltraps
80105f7d:	e9 21 f9 ff ff       	jmp    801058a3 <alltraps>
...
80105f84:	6a 3f                	push   $0x3f
  jmp alltraps
80105f86:	e9 18 f9 ff ff       	jmp    801058a3 <alltraps>
...
80105f8d:	6a 40                	push   $0x40
  jmp alltraps
80105f8f:	e9 0f f9 ff ff       	jmp    801058a3 <alltraps>
...
80105f96:	6a 41                	push   $0x41
  jmp alltraps
80105f98:	e9 06 f9 ff ff       	jmp    801058a3 <alltraps>
...
80105f9f:	6a 42                	push   $0x42
  jmp alltraps
80105fa1:	e9 fd f8 ff ff       	jmp    801058a3 <alltraps>
...
80105fa8:	6a 43                	push   $0x43
  jmp alltraps
80105faa:	e9 f4 f8 ff ff       	jmp    801058a3 <alltraps>
...
80105fb1:	6a 44                	push   $0x44
  jmp alltraps
80105fb3:	e9 eb f8 ff ff       	jmp    801058a3 <alltraps>
...
80105fba:	6a 45                	push   $0x45
  jmp alltraps
80105fbc:	e9 e2 f8 ff ff       	jmp    801058a3 <alltraps>
...
80105fc3:	6a 46                	push   $0x46
  jmp alltraps
80105fc5:	e9 d9 f8 ff ff       	jmp    801058a3 <alltraps>
...
80105fcc:	6a 47                	push   $0x47
  jmp alltraps
80105fce:	e9 d0 f8 ff ff       	jmp    801058a3 <alltraps>
...
80105fd5:	6a 48                	push   $0x48
  jmp alltraps
80105fd7:	e9 c7 f8 ff ff       	jmp    801058a3 <alltraps>
...
80105fde:	6a 49                	push   $0x49
  jmp alltraps
80105fe0:	e9 be f8 ff ff       	jmp    801058a3 <alltraps>
...
80105fe7:	6a 4a                	push   $0x4a
  jmp alltraps
80105fe9:	e9 b5 f8 ff ff       	jmp    801058a3 <alltraps>
...
80105ff0:	6a 4b                	push   $0x4b
  jmp alltraps
80105ff2:	e9 ac f8 ff ff       	jmp    801058a3 <alltraps>
...
80105ff9:	6a 4c                	push   $0x4c
  jmp alltraps
80105ffb:	e9 a3 f8 ff ff       	jmp    801058a3 <alltraps>
...
80106002:	6a 4d                	push   $0x4d
  jmp alltraps
80106004:	e9 9a f8 ff ff       	jmp    801058a3 <alltraps>
...
8010600b:	6a 4e                	push   $0x4e
  jmp alltraps
8010600d:	e9 91 f8 ff ff       	jmp    801058a3 <alltraps>
...
80106014:	6a 4f                	push   $0x4f
  jmp alltraps
80106016:	e9 88 f8 ff ff       	jmp    801058a3 <alltraps>
...
8010601d:	6a 50                	push   $0x50
  jmp alltraps
8010601f:	e9 7f f8 ff ff       	jmp    801058a3 <alltraps>
...
80106026:	6a 51                	push   $0x51
  jmp alltraps
80106028:	e9 76 f8 ff ff       	jmp    801058a3 <alltraps>
...
8010602f:	6a 52                	push   $0x52
  jmp alltraps
80106031:	e9 6d f8 ff ff       	jmp    801058a3 <alltraps>
...
80106038:	6a 53                	push   $0x53
  jmp alltraps
8010603a:	e9 64 f8 ff ff       	jmp    801058a3 <alltraps>
...
80106041:	6a 54                	push   $0x54
  jmp alltraps
80106043:	e9 5b f8 ff ff       	jmp    801058a3 <alltraps>
...
8010604a:	6a 55                	push   $0x55
  jmp alltraps
8010604c:	e9 52 f8 ff ff       	jmp    801058a3 <alltraps>
...
80106053:	6a 56                	push   $0x56
  jmp alltraps
80106055:	e9 49 f8 ff ff       	jmp    801058a3 <alltraps>
...
8010605c:	6a 57                	push   $0x57
  jmp alltraps
8010605e:	e9 40 f8 ff ff       	jmp    801058a3 <alltraps>
...
80106065:	6a 58                	push   $0x58
  jmp alltraps
80106067:	e9 37 f8 ff ff       	jmp    801058a3 <alltraps>
...
8010606e:	6a 59                	push   $0x59
  jmp alltraps
80106070:	e9 2e f8 ff ff       	jmp    801058a3 <alltraps>
...
80106077:	6a 5a                	push   $0x5a
  jmp alltraps
80106079:	e9 25 f8 ff ff       	jmp    801058a3 <alltraps>
...
80106080:	6a 5b                	push   $0x5b
  jmp alltraps
80106082:	e9 1c f8 ff ff       	jmp    801058a3 <alltraps>
...
80106089:	6a 5c                	push   $0x5c
  jmp alltraps
8010608b:	e9 13 f8 ff ff       	jmp    801058a3 <alltraps>
...
80106092:	6a 5d                	push   $0x5d
  jmp alltraps
80106094:	e9 0a f8 ff ff       	jmp    801058a3 <alltraps>
...
8010609b:	6a 5e                	push   $0x5e
  jmp alltraps
8010609d:	e9 01 f8 ff ff       	jmp    801058a3 <alltraps>
...
801060a4:	6a 5f                	push   $0x5f
  jmp alltraps
801060a6:	e9 f8 f7 ff ff       	jmp    801058a3 <alltraps>
...
801060ad:	6a 60                	push   $0x60
  jmp alltraps
801060af:	e9 ef f7 ff ff       	jmp    801058a3 <alltraps>
...
801060b6:	6a 61                	push   $0x61
  jmp alltraps
801060b8:	e9 e6 f7 ff ff       	jmp    801058a3 <alltraps>
...
801060bf:	6a 62                	push   $0x62
  jmp alltraps
801060c1:	e9 dd f7 ff ff       	jmp    801058a3 <alltraps>
...
801060c8:	6a 63                	push   $0x63
  jmp alltraps
801060ca:	e9 d4 f7 ff ff       	jmp    801058a3 <alltraps>
...
801060d1:	6a 64                	push   $0x64
  jmp alltraps
801060d3:	e9 cb f7 ff ff       	jmp    801058a3 <alltraps>
...
801060da:	6a 65                	push   $0x65
  jmp alltraps
801060dc:	e9 c2 f7 ff ff       	jmp    801058a3 <alltraps>
...
801060e3:	6a 66                	push   $0x66
  jmp alltraps
801060e5:	e9 b9 f7 ff ff       	jmp    801058a3 <alltraps>
...
801060ec:	6a 67                	push   $0x67
  jmp alltraps
801060ee:	e9 b0 f7 ff ff       	jmp    801058a3 <alltraps>
...
801060f5:	6a 68                	push   $0x68
  jmp alltraps
801060f7:	e9 a7 f7 ff ff       	jmp    801058a3 <alltraps>
...
801060fe:	6a 69                	push   $0x69
  jmp alltraps
80106100:	e9 9e f7 ff ff       	jmp    801058a3 <alltraps>
...
80106107:	6a 6a                	push   $0x6a
  jmp alltraps
80106109:	e9 95 f7 ff ff       	jmp    801058a3 <alltraps>
...
80106110:	6a 6b                	push   $0x6b
  jmp alltraps
80106112:	e9 8c f7 ff ff       	jmp    801058a3 <alltraps>
...
80106119:	6a 6c                	push   $0x6c
  jmp alltraps
8010611b:	e9 83 f7 ff ff       	jmp    801058a3 <alltraps>
...
80106122:	6a 6d                	push   $0x6d
  jmp alltraps
80106124:	e9 7a f7 ff ff       	jmp    801058a3 <alltraps>
...
8010612b:	6a 6e                	push   $0x6e
  jmp alltraps
8010612d:	e9 71 f7 ff ff       	jmp    801058a3 <alltraps>
...
80106134:	6a 6f                	push   $0x6f
  jmp alltraps
80106136:	e9 68 f7 ff ff       	jmp    801058a3 <alltraps>
...
8010613d:	6a 70                	push   $0x70
  jmp alltraps
8010613f:	e9 5f f7 ff ff       	jmp    801058a3 <alltraps>
...
80106146:	6a 71                	push   $0x71
  jmp alltraps
80106148:	e9 56 f7 ff ff       	jmp    801058a3 <alltraps>
...
8010614f:	6a 72                	push   $0x72
  jmp alltraps
80106151:	e9 4d f7 ff ff       	jmp    801058a3 <alltraps>
...
80106158:	6a 73                	push   $0x73
  jmp alltraps
8010615a:	e9 44 f7 ff ff       	jmp    801058a3 <alltraps>
...
80106161:	6a 74                	push   $0x74
  jmp alltraps
80106163:	e9 3b f7 ff ff       	jmp    801058a3 <alltraps>
...
8010616a:	6a 75                	push   $0x75
  jmp alltraps
8010616c:	e9 32 f7 ff ff       	jmp    801058a3 <alltraps>
...
80106173:	6a 76                	push   $0x76
  jmp alltraps
80106175:	e9 29 f7 ff ff       	jmp    801058a3 <alltraps>
...
8010617c:	6a 77                	push   $0x77
  jmp alltraps
8010617e:	e9 20 f7 ff ff       	jmp    801058a3 <alltraps>
...
80106185:	6a 78                	push   $0x78
  jmp alltraps
80106187:	e9 17 f7 ff ff       	jmp    801058a3 <alltraps>
...
8010618e:	6a 79                	push   $0x79
  jmp alltraps
80106190:	e9 0e f7 ff ff       	jmp    801058a3 <alltraps>
...
80106197:	6a 7a                	push   $0x7a
  jmp alltraps
80106199:	e9 05 f7 ff ff       	jmp    801058a3 <alltraps>
...
801061a0:	6a 7b                	push   $0x7b
  jmp alltraps
801061a2:	e9 fc f6 ff ff       	jmp    801058a3 <alltraps>
...
801061a9:	6a 7c                	push   $0x7c
  jmp alltraps
801061ab:	e9 f3 f6 ff ff       	jmp    801058a3 <alltraps>
...
801061b2:	6a 7d                	push   $0x7d
  jmp alltraps
801061b4:	e9 ea f6 ff ff       	jmp    801058a3 <alltraps>
...
801061bb:	6a 7e                	push   $0x7e
  jmp alltraps
801061bd:	e9 e1 f6 ff ff       	jmp    801058a3 <alltraps>
...
801061c4:	6a 7f                	push   $0x7f
  jmp alltraps
801061c6:	e9 d8 f6 ff ff       	jmp    801058a3 <alltraps>
...
801061cd:	68 80 00 00 00       	push   $0x80
  jmp alltraps
801061d2:	e9 cc f6 ff ff       	jmp    801058a3 <alltraps>
...
801061d9:	68 81 00 00 00       	push   $0x81
  jmp alltraps
801061de:	e9 c0 f6 ff ff       	jmp    801058a3 <alltraps>
...
801061e5:	68 82 00 00 00       	push   $0x82
  jmp alltraps
801061ea:	e9 b4 f6 ff ff       	jmp    801058a3 <alltraps>
...
801061f1:	68 83 00 00 00       	push   $0x83
  jmp alltraps
801061f6:	e9 a8 f6 ff ff       	jmp    801058a3 <alltraps>
...
801061fd:	68 84 00 00 00       	push   $0x84
  jmp alltraps
80106202:	e9 9c f6 ff ff       	jmp    801058a3 <alltraps>
...
80106209:	68 85 00 00 00       	push   $0x85
  jmp alltraps
8010620e:	e9 90 f6 ff ff       	jmp    801058a3 <alltraps>
...
80106215:	68 86 00 00 00       	push   $0x86
  jmp alltraps
8010621a:	e9 84 f6 ff ff       	jmp    801058a3 <alltraps>
...
80106221:	68 87 00 00 00       	push   $0x87
  jmp alltraps
80106226:	e9 78 f6 ff ff       	jmp    801058a3 <alltraps>
...
8010622d:	68 88 00 00 00       	push   $0x88
  jmp alltraps
80106232:	e9 6c f6 ff ff       	jmp    801058a3 <alltraps>
...
80106239:	68 89 00 00 00       	push   $0x89
  jmp alltraps
8010623e:	e9 60 f6 ff ff       	jmp    801058a3 <alltraps>
...
80106245:	68 8a 00 00 00       	push   $0x8a
  jmp alltraps
8010624a:	e9 54 f6 ff ff       	jmp    801058a3 <alltraps>
...
80106251:	68 8b 00 00 00       	push   $0x8b
  jmp alltraps
80106256:	e9 48 f6 ff ff       	jmp    801058a3 <alltraps>
...
8010625d:	68 8c 00 00 00       	push   $0x8c
  jmp alltraps
80106262:	e9 3c f6 ff ff       	jmp    801058a3 <alltraps>
...
80106269:	68 8d 00 00 00       	push   $0x8d
  jmp alltraps
8010626e:	e9 30 f6 ff ff       	jmp    801058a3 <alltraps>
...
80106275:	68 8e 00 00 00       	push   $0x8e
  jmp alltraps
8010627a:	e9 24 f6 ff ff       	jmp    801058a3 <alltraps>
...
80106281:	68 8f 00 00 00       	push   $0x8f
  jmp alltraps
80106286:	e9 18 f6 ff ff       	jmp    801058a3 <alltraps>
...
8010628d:	68 90 00 00 00       	push   $0x90
  jmp alltraps
80106292:	e9 0c f6 ff ff       	jmp    801058a3 <alltraps>
...
80106299:	68 91 00 00 00       	push   $0x91
  jmp alltraps
8010629e:	e9 00 f6 ff ff       	jmp    801058a3 <alltraps>
...
801062a5:	68 92 00 00 00       	push   $0x92
  jmp alltraps
801062aa:	e9 f4 f5 ff ff       	jmp    801058a3 <alltraps>
...
801062b1:	68 93 00 00 00       	push   $0x93
  jmp alltraps
801062b6:	e9 e8 f5 ff ff       	jmp    801058a3 <alltraps>
...
801062bd:	68 94 00 00 00       	push   $0x94
  jmp alltraps
801062c2:	e9 dc f5 ff ff       	jmp    801058a3 <alltraps>
...
801062c9:	68 95 00 00 00       	push   $0x95
  jmp alltraps
801062ce:	e9 d0 f5 ff ff       	jmp    801058a3 <alltraps>
...
801062d5:	68 96 00 00 00       	push   $0x96
  jmp alltraps
801062da:	e9 c4 f5 ff ff       	jmp    801058a3 <alltraps>
...
801062e1:	68 97 00 00 00       	push   $0x97
  jmp alltraps
801062e6:	e9 b8 f5 ff ff       	jmp    801058a3 <alltraps>
...
801062ed:	68 98 00 00 00       	push   $0x98
  jmp alltraps
801062f2:	e9 ac f5 ff ff       	jmp    801058a3 <alltraps>
...
801062f9:	68 99 00 00 00       	push   $0x99
  jmp alltraps
801062fe:	e9 a0 f5 ff ff       	jmp    801058a3 <alltraps>
...
80106305:	68 9a 00 00 00       	push   $0x9a
  jmp alltraps
8010630a:	e9 94 f5 ff ff       	jmp    801058a3 <alltraps>
...
80106311:	68 9b 00 00 00       	push   $0x9b
  jmp alltraps
80106316:	e9 88 f5 ff ff       	jmp    801058a3 <alltraps>
...
8010631d:	68 9c 00 00 00       	push   $0x9c
  jmp alltraps
80106322:	e9 7c f5 ff ff       	jmp    801058a3 <alltraps>
...
80106329:	68 9d 00 00 00       	push   $0x9d
  jmp alltraps
8010632e:	e9 70 f5 ff ff       	jmp    801058a3 <alltraps>
...
80106335:	68 9e 00 00 00       	push   $0x9e
  jmp alltraps
8010633a:	e9 64 f5 ff ff       	jmp    801058a3 <alltraps>
...
80106341:	68 9f 00 00 00       	push   $0x9f
  jmp alltraps
80106346:	e9 58 f5 ff ff       	jmp    801058a3 <alltraps>
...
8010634d:	68 a0 00 00 00       	push   $0xa0
  jmp alltraps
80106352:	e9 4c f5 ff ff       	jmp    801058a3 <alltraps>
...
80106359:	68 a1 00 00 00       	push   $0xa1
  jmp alltraps
8010635e:	e9 40 f5 ff ff       	jmp    801058a3 <alltraps>
...
80106365:	68 a2 00 00 00       	push   $0xa2
  jmp alltraps
8010636a:	e9 34 f5 ff ff       	jmp    801058a3 <alltraps>
...
80106371:	68 a3 00 00 00       	push   $0xa3
  jmp alltraps
80106376:	e9 28 f5 ff ff       	jmp    801058a3 <alltraps>
...
8010637d:	68 a4 00 00 00       	push   $0xa4
  jmp alltraps
80106382:	e9 1c f5 ff ff       	jmp    801058a3 <alltraps>
...
80106389:	68 a5 00 00 00       	push   $0xa5
  jmp alltraps
8010638e:	e9 10 f5 ff ff       	jmp    801058a3 <alltraps>
...
80106395:	68 a6 00 00 00       	push   $0xa6
  jmp alltraps
8010639a:	e9 04 f5 ff ff       	jmp    801058a3 <alltraps>
...
801063a1:	68 a7 00 00 00       	push   $0xa7
  jmp alltraps
801063a6:	e9 f8 f4 ff ff       	jmp    801058a3 <alltraps>
...
801063ad:	68 a8 00 00 00       	push   $0xa8
  jmp alltraps
801063b2:	e9 ec f4 ff ff       	jmp    801058a3 <alltraps>
...
801063b9:	68 a9 00 00 00       	push   $0xa9
  jmp alltraps
801063be:	e9 e0 f4 ff ff       	jmp    801058a3 <alltraps>
...
801063c5:	68 aa 00 00 00       	push   $0xaa
  jmp alltraps
801063ca:	e9 d4 f4 ff ff       	jmp    801058a3 <alltraps>
...
801063d1:	68 ab 00 00 00       	push   $0xab
  jmp alltraps
801063d6:	e9 c8 f4 ff ff       	jmp    801058a3 <alltraps>
...
801063dd:	68 ac 00 00 00       	push   $0xac
  jmp alltraps
801063e2:	e9 bc f4 ff ff       	jmp    801058a3 <alltraps>
...
801063e9:	68 ad 00 00 00       	push   $0xad
  jmp alltraps
801063ee:	e9 b0 f4 ff ff       	jmp    801058a3 <alltraps>
...
801063f5:	68 ae 00 00 00       	push   $0xae
  jmp alltraps
801063fa:	e9 a4 f4 ff ff       	jmp    801058a3 <alltraps>
...
80106401:	68 af 00 00 00       	push   $0xaf
  jmp alltraps
80106406:	e9 98 f4 ff ff       	jmp    801058a3 <alltraps>
...
8010640d:	68 b0 00 00 00       	push   $0xb0
  jmp alltraps
80106412:	e9 8c f4 ff ff       	jmp    801058a3 <alltraps>
...
80106419:	68 b1 00 00 00       	push   $0xb1
  jmp alltraps
8010641e:	e9 80 f4 ff ff       	jmp    801058a3 <alltraps>
...
80106425:	68 b2 00 00 00       	push   $0xb2
  jmp alltraps
8010642a:	e9 74 f4 ff ff       	jmp    801058a3 <alltraps>
...
80106431:	68 b3 00 00 00       	push   $0xb3
  jmp alltraps
80106436:	e9 68 f4 ff ff       	jmp    801058a3 <alltraps>
...
8010643d:	68 b4 00 00 00       	push   $0xb4
  jmp alltraps
80106442:	e9 5c f4 ff ff       	jmp    801058a3 <alltraps>
...
80106449:	68 b5 00 00 00       	push   $0xb5
  jmp alltraps
8010644e:	e9 50 f4 ff ff       	jmp    801058a3 <alltraps>
...
80106455:	68 b6 00 00 00       	push   $0xb6
  jmp alltraps
8010645a:	e9 44 f4 ff ff       	jmp    801058a3 <alltraps>
...
80106461:	68 b7 00 00 00       	push   $0xb7
  jmp alltraps
80106466:	e9 38 f4 ff ff       	jmp    801058a3 <alltraps>
...
8010646d:	68 b8 00 00 00       	push   $0xb8
  jmp alltraps
80106472:	e9 2c f4 ff ff       	jmp    801058a3 <alltraps>
...
80106479:	68 b9 00 00 00       	push   $0xb9
  jmp alltraps
8010647e:	e9 20 f4 ff ff       	jmp    801058a3 <alltraps>
...
80106485:	68 ba 00 00 00       	push   $0xba
  jmp alltraps
8010648a:	e9 14 f4 ff ff       	jmp    801058a3 <alltraps>
...
80106491:	68 bb 00 00 00       	push   $0xbb
  jmp alltraps
80106496:	e9 08 f4 ff ff       	jmp    801058a3 <alltraps>
...
8010649d:	68 bc 00 00 00       	push   $0xbc
  jmp alltraps
801064a2:	e9 fc f3 ff ff       	jmp    801058a3 <alltraps>
...
801064a9:	68 bd 00 00 00       	push   $0xbd
  jmp alltraps
801064ae:	e9 f0 f3 ff ff       	jmp    801058a3 <alltraps>
...
801064b5:	68 be 00 00 00       	push   $0xbe
  jmp alltraps
801064ba:	e9 e4 f3 ff ff       	jmp    801058a3 <alltraps>
...
801064c1:	68 bf 00 00 00       	push   $0xbf
  jmp alltraps
801064c6:	e9 d8 f3 ff ff       	jmp    801058a3 <alltraps>
...
801064cd:	68 c0 00 00 00       	push   $0xc0
  jmp alltraps
801064d2:	e9 cc f3 ff ff       	jmp    801058a3 <alltraps>
...
801064d9:	68 c1 00 00 00       	push   $0xc1
  jmp alltraps
801064de:	e9 c0 f3 ff ff       	jmp    801058a3 <alltraps>
...
801064e5:	68 c2 00 00 00       	push   $0xc2
  jmp alltraps
801064ea:	e9 b4 f3 ff ff       	jmp    801058a3 <alltraps>
...
801064f1:	68 c3 00 00 00       	push   $0xc3
  jmp alltraps
801064f6:	e9 a8 f3 ff ff       	jmp    801058a3 <alltraps>
...
801064fd:	68 c4 00 00 00       	push   $0xc4
  jmp alltraps
80106502:	e9 9c f3 ff ff       	jmp    801058a3 <alltraps>
...
80106509:	68 c5 00 00 00       	push   $0xc5
  jmp alltraps
8010650e:	e9 90 f3 ff ff       	jmp    801058a3 <alltraps>
...
80106515:	68 c6 00 00 00       	push   $0xc6
  jmp alltraps
8010651a:	e9 84 f3 ff ff       	jmp    801058a3 <alltraps>
...
80106521:	68 c7 00 00 00       	push   $0xc7
  jmp alltraps
80106526:	e9 78 f3 ff ff       	jmp    801058a3 <alltraps>
...
8010652d:	68 c8 00 00 00       	push   $0xc8
  jmp alltraps
80106532:	e9 6c f3 ff ff       	jmp    801058a3 <alltraps>
...
80106539:	68 c9 00 00 00       	push   $0xc9
  jmp alltraps
8010653e:	e9 60 f3 ff ff       	jmp    801058a3 <alltraps>
...
80106545:	68 ca 00 00 00       	push   $0xca
  jmp alltraps
8010654a:	e9 54 f3 ff ff       	jmp    801058a3 <alltraps>
...
80106551:	68 cb 00 00 00       	push   $0xcb
  jmp alltraps
80106556:	e9 48 f3 ff ff       	jmp    801058a3 <alltraps>
...
8010655d:	68 cc 00 00 00       	push   $0xcc
  jmp alltraps
80106562:	e9 3c f3 ff ff       	jmp    801058a3 <alltraps>
...
80106569:	68 cd 00 00 00       	push   $0xcd
  jmp alltraps
8010656e:	e9 30 f3 ff ff       	jmp    801058a3 <alltraps>
...
80106575:	68 ce 00 00 00       	push   $0xce
  jmp alltraps
8010657a:	e9 24 f3 ff ff       	jmp    801058a3 <alltraps>
...
80106581:	68 cf 00 00 00       	push   $0xcf
  jmp alltraps
80106586:	e9 18 f3 ff ff       	jmp    801058a3 <alltraps>
...
8010658d:	68 d0 00 00 00       	push   $0xd0
  jmp alltraps
80106592:	e9 0c f3 ff ff       	jmp    801058a3 <alltraps>
...
80106599:	68 d1 00 00 00       	push   $0xd1
  jmp alltraps
8010659e:	e9 00 f3 ff ff       	jmp    801058a3 <alltraps>
...
801065a5:	68 d2 00 00 00       	push   $0xd2
  jmp alltraps
801065aa:	e9 f4 f2 ff ff       	jmp    801058a3 <alltraps>
...
801065b1:	68 d3 00 00 00       	push   $0xd3
  jmp alltraps
801065b6:	e9 e8 f2 ff ff       	jmp    801058a3 <alltraps>
...
801065bd:	68 d4 00 00 00       	push   $0xd4
  jmp alltraps
801065c2:	e9 dc f2 ff ff       	jmp    801058a3 <alltraps>
...
801065c9:	68 d5 00 00 00       	push   $0xd5
  jmp alltraps
801065ce:	e9 d0 f2 ff ff       	jmp    801058a3 <alltraps>
...
801065d5:	68 d6 00 00 00       	push   $0xd6
  jmp alltraps
801065da:	e9 c4 f2 ff ff       	jmp    801058a3 <alltraps>
...
801065e1:	68 d7 00 00 00       	push   $0xd7
  jmp alltraps
801065e6:	e9 b8 f2 ff ff       	jmp    801058a3 <alltraps>
...
801065ed:	68 d8 00 00 00       	push   $0xd8
  jmp alltraps
801065f2:	e9 ac f2 ff ff       	jmp    801058a3 <alltraps>
...
801065f9:	68 d9 00 00 00       	push   $0xd9
  jmp alltraps
801065fe:	e9 a0 f2 ff ff       	jmp    801058a3 <alltraps>
...
80106605:	68 da 00 00 00       	push   $0xda
  jmp alltraps
8010660a:	e9 94 f2 ff ff       	jmp    801058a3 <alltraps>
...
80106611:	68 db 00 00 00       	push   $0xdb
  jmp alltraps
80106616:	e9 88 f2 ff ff       	jmp    801058a3 <alltraps>
...
8010661d:	68 dc 00 00 00       	push   $0xdc
  jmp alltraps
80106622:	e9 7c f2 ff ff       	jmp    801058a3 <alltraps>
...
80106629:	68 dd 00 00 00       	push   $0xdd
  jmp alltraps
8010662e:	e9 70 f2 ff ff       	jmp    801058a3 <alltraps>
...
80106635:	68 de 00 00 00       	push   $0xde
  jmp alltraps
8010663a:	e9 64 f2 ff ff       	jmp    801058a3 <alltraps>
...
80106641:	68 df 00 00 00       	push   $0xdf
  jmp alltraps
80106646:	e9 58 f2 ff ff       	jmp    801058a3 <alltraps>
...
8010664d:	68 e0 00 00 00       	push   $0xe0
  jmp alltraps
80106652:	e9 4c f2 ff ff       	jmp    801058a3 <alltraps>
...
80106659:	68 e1 00 00 00       	push   $0xe1
  jmp alltraps
8010665e:	e9 40 f2 ff ff       	jmp    801058a3 <alltraps>
...
80106665:	68 e2 00 00 00       	push   $0xe2
  jmp alltraps
8010666a:	e9 34 f2 ff ff       	jmp    801058a3 <alltraps>
...
80106671:	68 e3 00 00 00       	push   $0xe3
  jmp alltraps
80106676:	e9 28 f2 ff ff       	jmp    801058a3 <alltraps>
...
8010667d:	68 e4 00 00 00       	push   $0xe4
  jmp alltraps
80106682:	e9 1c f2 ff ff       	jmp    801058a3 <alltraps>
...
80106689:	68 e5 00 00 00       	push   $0xe5
  jmp alltraps
8010668e:	e9 10 f2 ff ff       	jmp    801058a3 <alltraps>
...
80106695:	68 e6 00 00 00       	push   $0xe6
  jmp alltraps
8010669a:	e9 04 f2 ff ff       	jmp    801058a3 <alltraps>
...
801066a1:	68 e7 00 00 00       	push   $0xe7
  jmp alltraps
801066a6:	e9 f8 f1 ff ff       	jmp    801058a3 <alltraps>
...
801066ad:	68 e8 00 00 00       	push   $0xe8
  jmp alltraps
801066b2:	e9 ec f1 ff ff       	jmp    801058a3 <alltraps>
...
801066b9:	68 e9 00 00 00       	push   $0xe9
  jmp alltraps
801066be:	e9 e0 f1 ff ff       	jmp    801058a3 <alltraps>
...
801066c5:	68 ea 00 00 00       	push   $0xea
  jmp alltraps
801066ca:	e9 d4 f1 ff ff       	jmp    801058a3 <alltraps>
...
801066d1:	68 eb 00 00 00       	push   $0xeb
  jmp alltraps
801066d6:	e9 c8 f1 ff ff       	jmp    801058a3 <alltraps>
...
801066dd:	68 ec 00 00 00       	push   $0xec
  jmp alltraps
801066e2:	e9 bc f1 ff ff       	jmp    801058a3 <alltraps>
...
801066e9:	68 ed 00 00 00       	push   $0xed
  jmp alltraps
801066ee:	e9 b0 f1 ff ff       	jmp    801058a3 <alltraps>
...
801066f5:	68 ee 00 00 00       	push   $0xee
  jmp alltraps
801066fa:	e9 a4 f1 ff ff       	jmp    801058a3 <alltraps>
...
80106701:	68 ef 00 00 00       	push   $0xef
  jmp alltraps
80106706:	e9 98 f1 ff ff       	jmp    801058a3 <alltraps>
...
8010670d:	68 f0 00 00 00       	push   $0xf0
  jmp alltraps
80106712:	e9 8c f1 ff ff       	jmp    801058a3 <alltraps>
...
80106719:	68 f1 00 00 00       	push   $0xf1
  jmp alltraps
8010671e:	e9 80 f1 ff ff       	jmp    801058a3 <alltraps>
...
80106725:	68 f2 00 00 00       	push   $0xf2
  jmp alltraps
8010672a:	e9 74 f1 ff ff       	jmp    801058a3 <alltraps>
...
80106731:	68 f3 00 00 00       	push   $0xf3
  jmp alltraps
80106736:	e9 68 f1 ff ff       	jmp    801058a3 <alltraps>
...
8010673d:	68 f4 00 00 00       	push   $0xf4
  jmp alltraps
80106742:	e9 5c f1 ff ff       	jmp    801058a3 <alltraps>
...
80106749:	68 f5 00 00 00       	push   $0xf5
  jmp alltraps
8010674e:	e9 50 f1 ff ff       	jmp    801058a3 <alltraps>
...
80106755:	68 f6 00 00 00       	push   $0xf6
  jmp alltraps
8010675a:	e9 44 f1 ff ff       	jmp    801058a3 <alltraps>
...
80106761:	68 f7 00 00 00       	push   $0xf7
  jmp alltraps
80106766:	e9 38 f1 ff ff       	jmp    801058a3 <alltraps>
...
8010676d:	68 f8 00 00 00       	push   $0xf8
  jmp alltraps
80106772:	e9 2c f1 ff ff       	jmp    801058a3 <alltraps>
...
80106779:	68 f9 00 00 00       	push   $0xf9
  jmp alltraps
8010677e:	e9 20 f1 ff ff       	jmp    801058a3 <alltraps>
...
80106785:	68 fa 00 00 00       	push   $0xfa
  jmp alltraps
8010678a:	e9 14 f1 ff ff       	jmp    801058a3 <alltraps>
...
80106791:	68 fb 00 00 00       	push   $0xfb
  jmp alltraps
80106796:	e9 08 f1 ff ff       	jmp    801058a3 <alltraps>
...
8010679d:	68 fc 00 00 00       	push   $0xfc
  jmp alltraps
801067a2:	e9 fc f0 ff ff       	jmp    801058a3 <alltraps>
...
801067a9:	68 fd 00 00 00       	push   $0xfd
  jmp alltraps
801067ae:	e9 f0 f0 ff ff       	jmp    801058a3 <alltraps>
...
801067b5:	68 fe 00 00 00       	push   $0xfe
  jmp alltraps
801067ba:	e9 e4 f0 ff ff       	jmp    801058a3 <alltraps>
...
801067c1:	68 ff 00 00 00       	push   $0xff
  jmp alltraps
801067c6:	e9 d8 f0 ff ff       	jmp    801058a3 <alltraps>
...
801068cd:	68 ec 79 10 80       	push   $0x801079ec
...
801069ae:	c7 80 18 28 11 80 ff 	movl   $0xffff,-0x7feed7e8(%eax)
801069b5:	ff 00 00 
801069b8:	c7 80 1c 28 11 80 00 	movl   $0xcf9a00,-0x7feed7e4(%eax)
801069bf:	9a cf 00 
  c->gdt[SEG_KDATA] = SEG(STA_W, 0, 0xffffffff, 0);
801069c2:	c7 80 20 28 11 80 ff 	movl   $0xffff,-0x7feed7e0(%eax)
801069c9:	ff 00 00 
801069cc:	c7 80 24 28 11 80 00 	movl   $0xcf9200,-0x7feed7dc(%eax)
801069d3:	92 cf 00 
  c->gdt[SEG_UCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, DPL_USER);
801069d6:	c7 80 28 28 11 80 ff 	movl   $0xffff,-0x7feed7d8(%eax)
801069dd:	ff 00 00 
801069e0:	c7 80 2c 28 11 80 00 	movl   $0xcffa00,-0x7feed7d4(%eax)
801069e7:	fa cf 00 
  c->gdt[SEG_UDATA] = SEG(STA_W, 0, 0xffffffff, DPL_USER);
801069ea:	c7 80 30 28 11 80 ff 	movl   $0xffff,-0x7feed7d0(%eax)
801069f1:	ff 00 00 
801069f4:	c7 80 34 28 11 80 00 	movl   $0xcff200,-0x7feed7cc(%eax)
801069fb:	f2 cf 00 
  lgdt(c->gdt, sizeof(c->gdt));
801069fe:	05 10 28 11 80       	add    $0x80112810,%eax
  pd[1] = (uint)p;
...
80106a24:	a1 c4 54 11 80       	mov    0x801154c4,%eax
...
80106a68:	0f 84 c2 00 00 00    	je     80106b30 <switchuvm+0xf0>
  pushcli();
80106a6e:	e8 0d da ff ff       	call   80104480 <pushcli>
...
80106b83:	e8 08 db ff ff       	call   80104690 <memset>
...
80106bb6:	5d                   	pop    %ebp
  memmove(mem, init, sz);
80106bb7:	e9 74 db ff ff       	jmp    80104730 <memmove>
    panic("inituvm: more than a page");
80106bbc:	83 ec 0c             	sub    $0xc,%esp
80106bbf:	68 31 7a 10 80       	push   $0x80107a31
...
80106ceb:	e8 a0 d9 ff ff       	call   80104690 <memset>
...
80106d29:	68 69 7a 10 80       	push   $0x80107a69
...
80106d8b:	68 81 7a 10 80       	push   $0x80107a81
...
80106ea4:	e8 e7 d7 ff ff       	call   80104690 <memset>
...
80106f0f:	a3 c4 54 11 80       	mov    %eax,0x801154c4
  lcr3(V2P(kpgdir));   // switch to the kernel page table
...
80106f43:	68 ae 7a 10 80       	push   $0x80107aae
...
80106f90:	e8 9b d7 ff ff       	call   80104730 <memmove>
...
801070be:	e8 6d d6 ff ff       	call   80104730 <memmove>
    len -= n;
    buf += n;
