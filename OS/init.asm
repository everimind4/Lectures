 ...
 40c:	89 d1                	mov    %edx,%ecx
{
 ...
 439:	0f b6 92 94 08 00 00 	movzbl 0x894(%edx),%edx
...
printf(int fd, const char *fmt, ...)
{
 ...
 634:	eb 1a                	jmp    650 <printf+0x1a0>
          s = "(null)";
 636:	bb 8c 08 00 00       	mov    $0x88c,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 685:	a1 48 0b 00 00       	mov    0xb48,%eax
{
 ...
 6a6:	73 10                	jae    6b8 <free+0x38>
{
 ...
 6d1:	5b                   	pop    %ebx
  freep = p;
 6d2:	a3 48 0b 00 00       	mov    %eax,0xb48
}
 6d7:	5e                   	pop    %esi
 6d8:	5f                   	pop    %edi
 6d9:	5d                   	pop    %ebp
 ...
 6f7:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 6fa:	a3 48 0b 00 00       	mov    %eax,0xb48
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 71d:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 720:	8b 3d 48 0b 00 00    	mov    0xb48,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 769:	8b 3d 48 0b 00 00    	mov    0xb48,%edi
 ...
 792:	e8 e9 fe ff ff       	call   680 <free>
  return freep;
 797:	a1 48 0b 00 00       	mov    0xb48,%eax
 ...
 7e7:	0b 00 00 
    base.s.size = 0;
 7ea:	bf 4c 0b 00 00       	mov    $0xb4c,%edi
    base.s.ptr = freep = prevp = &base;
 ...
 7f9:	89 f8                	mov    %edi,%eax
    base.s.size = 0;
 7fb:	c7 05 50 0b 00 00 00 	movl   $0x0,0xb50
 802:	00 00 00 
    if(p->s.size >= nunits){
